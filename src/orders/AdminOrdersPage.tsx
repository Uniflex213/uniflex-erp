...
export default function AdminOrdersPage({ orders, onUpdateOrder }: Props) {
  ...
  return (
    <div>
      ...
      {viewOrder && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.35)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, overflowY: "auto", padding: "16px" }}>
