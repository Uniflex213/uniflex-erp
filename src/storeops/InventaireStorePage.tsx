  ...
  return (
    <div style={{ padding: "28px 32px", background: T.cardAlt, minHeight: "100%" }}>
      ...
      {modal === "history" && selectedProduct && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "flex-start", justifyContent: "center", zIndex: 1500, padding: 20, overflowY: "auto" }} onClick={() => { setModal(null); setSelectedProduct(null); }}>
...
function AdjustmentProductPicker({ products, onSelect, onClose }: { products: InventaireProduct[]; onSelect: (p: InventaireProduct) => void; onClose: () => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1500, padding: 20 }} onClick={onClose}>
