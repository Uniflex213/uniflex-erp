  ...
  return (
    <div style={{ padding: "28px 32px", background: T.cardAlt, minHeight: "100%" }}>
      ...
      {modal === "history" && selectedProduct && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.35)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", display: "flex", alignItems: "flex-start", justifyContent: "center", zIndex: 1500, padding: 20, overflowY: "auto" }} onClick={() => { setModal(null); setSelectedProduct(null); }}>
