...
export default function ConfirmBilledModal({ doc, onClose, onConfirmed }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.35)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", zIndex: 9500, display: "flex", justifyContent: "center", overflowY: "auto", padding: 20 }}>
