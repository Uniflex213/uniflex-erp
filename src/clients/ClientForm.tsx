...
export default function ClientForm({ initial, pricelists = [], clientCount = 0, onSave, onCancel, isConversion, isAdmin }: Props) {
  ...
  return (
    <>
      <div style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.35)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", zIndex: 9999 }} onClick={onCancel} />
      <div style={{
