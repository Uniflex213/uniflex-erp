...
function DeleteModal({ confirm, onChange, onConfirm }: { confirm: DeleteConfirm; onChange: (c: DeleteConfirm | null) => void; onConfirm: () => void }) {
  return (
    <>
      <div style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.85)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", zIndex: 9999 }} onClick={() => onChange(null)} />
