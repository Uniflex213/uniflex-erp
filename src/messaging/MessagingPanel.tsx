...
export default function MessagingPanel({ isOpen, onClose, currentUser, onUnreadChange }: Props) {
  ...
  return (
    <>
      <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(230,228,224,0.35)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", zIndex: 9400, backdropFilter: "blur(2px)" }} />
